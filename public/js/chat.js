...
$messageForm.addEventListener('submit', (e) => {
    ...
    $messageFormButton.setAttribute('disabled', 'disabled')  //disables button after first message sent. This prevents multiple presses.
    //disable form
    ...
    socket.emit('sendMessage', message, (error) => {
        ...
        //enable form. helps fix double clicks
        if (error) {
